...
enum ErrorCode {
    ...
    ELASTIC_SEARCH_SEARCH_GUARD_AUTHENTICATION_FAILED("69044", "ElasticSearch-SearchGuard authentication failed", "SC-SB-ELASTICSEARCH-SG-AUTHENTICATION-FAIL", HttpStatus.NETWORK_AUTHENTICATION_REQUIRED)
